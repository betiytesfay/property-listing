...
import { getPendingProperties } from '../../../../data/dummyProperties';
import { Property } from '../../../../types';
import { CheckCircle, XCircle } from 'lucide-react';

export default function PendingPropertiesPage() {
  const [properties, setProperties] = useState<Property[]>(getPendingProperties());
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500">Review properties waiting for approval ({properties.length} items)</p>
      </div>
